        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <h5 class="card-header">Update Programming Skill</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <form action="{{route('update.design.skill')}}" method="post"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="dskillname" class="form-control"
                                                           ...
                                                           placeholder="Name of skill" value="{{$edata->dskillname}}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="dskilllavel" class="form-control"
                                                           ...
                                                           placeholder="Skill Level Ex: 80,85,90..." value="{{$edata->dskilllavel}}">
                                                </div>

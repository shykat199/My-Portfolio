        ...
        <div id="content">
            ...
            <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#">My Skill Section</a>
                                <a class="dropdown-item" href="#">My Hobbies Section</a>
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <h5 class="card-header">My Skill Section</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card text-center">
                                        <div class="card-header">
                                            Codding / Programming Skill
                                        </div>
                                        <div class="card-body">
                                            <form action="{{route('add_programing_skill')}}" method="post"
                                                ...
                                                <div class="form-group">
                                                    <label class="text-left" for="exampleInputEmail1"
                                                           style="float: left;">Language Name</label>
                                                ...
                                                <div class="form-group">
                                                    <label class="text-left" for="exampleInputPassword1"
                                                           style="float: left;">Level</label>
                                                    <input type="text" name="skillevel" class="form-control"
                                                           id="exampleInputPassword1"
                                                           placeholder="Skill Level Ex: 80,85,90...">
                                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <form action="{{route('add_design_skill')}}" method="post"
                                                  enctype="multipart/form-data">
                                                @csrf

                                                <div class="form-group">
                                                    <label class="text-left" for="exampleInputEmail1"
                                                           style="float: left;">Deign Skill</label>
                                                    <input type="text" name="dskillname" class="form-control"
                                                           id="exampleInputEmail1" aria-describedby="emailHelp"
                                                ...
                                                <div class="form-group">
                                                    <label class="text-left" for="exampleInputPassword1"
                                                           style="float: left;">Level</label>
                                                    <input type="text" name="dskilllavel" class="form-control"
                                                           id="exampleInputPassword1"
                                                           placeholder="Skill Level Ex: 80,85,90...">
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table">
                                            ...
                                            @php
                                                $i = 1;
                                            @endphp
                                            @foreach ($pskill as $datas)
                                                <tr>
                                                    <th>{{ $i++ }}</th>
                                                    <th>{{ $datas->skillname }}</th>
                                                    <td>{{ $datas->skillevel }}</td>

                                                    <td>
                                                        <a class="btn btn-warning"
                                                           href="/admin/edit/programming_skill/{{ $datas->id }}">
                                ...
                                <div class="card text-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th scope="col">#</th>
                                                <th scope="col">Deign Skill</th>
                                                <th scope="col">Deign Level</th>
                                            ...
                                            @php
                                                $i = 1;
                                            @endphp
                                            @foreach ($dskill as $datas)
                                                <tr>
                                                    <th>{{ $i++ }}</th>
                                                    <th>{{ $datas->dskillname }}</th>
                                                    <td>{{ $datas->dskilllavel }}</td>


                                                    <td>
                                                        <a class="btn btn-warning"
                                                           href="/admin/edit/design_skill/{{ $datas->id }}">
                                                            <i class="fa-solid fa-pen-to-square"></i>
                                                        </a>
                                                        <a class="btn btn-danger mt-1"
                                                           href="/admin/delete/design_skill/{{ $datas->id }}">
                                                            <i class="fa-solid fa-trash"></i>
                                                        </a>
                                                    </td>

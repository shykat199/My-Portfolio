                                            ...
                                            <form action="{{route('update.education')}}" method="post"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                           ...
                                                           placeholder="Name of degree..." value="{{$edata->title}}">
                                                </div>
                                                <div class="form-group">
                                                    <label class="text-left" for="exampleInputPassword1"
                                                           style="float: left;">University</label>
                                                    <input type="text" name="organization" class="form-control"
                                                           id="exampleInputPassword1" placeholder="University name..." value="{{$edata->organization}}">
                                                </div>
                                                <div class="form-group">
                                                    <label class="text-left" for="exampleInputPassword1"
                                                    ...
                                                    <input type="text" name="time" class="form-control"
                                                           ...
                                                           placeholder="Duration of Degree Ex: 2018-2022 , 2020-2023" value="{{$edata->time}}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="about_exp" rows="4" cols="50"
                                                              ...
                                                              class="form-control">{{$edata->about_exp}}</textarea>
                                                </div>

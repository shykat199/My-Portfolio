                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="href="{{route('admin_profile')}}">
                ...
                <div class="row">
                    ...
                    <div class="container">
                        ...
                        <div class="card border-success">
                            ...
                            <form action="{{route('admin_Addprofile')}}" method="POST"
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="card text-center border-success">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="">
                                                        <label style="float: left;">Your Email Address</label>
                                            ...
                                            <div class="card text-center border-success">
                                                ...
                                                <div class="card-body border-success">
                                                    <div class="">
                                                        ...
                                                        <img id="reviewimage" alt="profile image"
                                                             style="max-width:130px;margin-top:20px;">

                                                    </div>

                                                    <div class=" mt-2">
                                                        <label style="float: left;" for="formFileMultiple"
                ...
                <div class="row ">
                    ...
                    <div class="container">
                        ...
                        <div class="card border-success">
                            ...
                            <form action="{{route('admin_updateprofile')}}" method="POST"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="card-body card-header border-success">
                                            ...
                                            <div class="card text-center border-success">
                                                ...
                                                <div class="card-body border-success">
                                                    <div class="">
                                                        ...
                                                        <img id="reviewimage" alt="profile image" src="{{asset('images/' . $getAllProfile->img)}}"
                                                             style="max-width:130px;margin-top:20px;">

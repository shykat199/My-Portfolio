        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <h5 class="card-header">Update Education & Professional Background</h5>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <form action="{{route('update.profrssion')}}" method="post"
                                                  enctype="multipart/form-data">
                                                @csrf

                                                <input type="hidden" name="type" value="p">
                                                <input type="hidden" name="id" value="{{$edata1->id}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                           ...
                                                           placeholder="Name of post Ex: Software Engineer,Java Developer"value="{{$edata1->title}}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="organization" class="form-control"
                                                           ...
                                                           placeholder="Organization name..." value="{{$edata1->organization}}>
                                                </div>
                                                <div class="form-group">
                                                    <label class="text-left" for="exampleInputPassword1"
                                                    ...
                                                    <input type="text" name="time" class="form-control"
                                                           id="exampleInputPassword1"
                                                           placeholder="Duration of Degree Ex: 2018-2022 , 2020-2023"value="{{$edata1->time}}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="about_exp" rows="4" cols="50"
                                                              ...
                                                              class="form-control">{{$edata1->about_exp}}</textarea>
                                                </div>
